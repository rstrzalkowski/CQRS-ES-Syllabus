...
import pl.lodz.p.it.rstrzalkowski.syllabus.queryside.exception.realisation.RealisationArchivedException;
...
public class AccessGuard {
    ...
    public void checkAccessToRealisation(UUID realisationId) {
        ...
        List<String> privilegedRoles = new ArrayList<>(Arrays.asList("OFFICE", "DIRECTOR", "ADMIN"));
